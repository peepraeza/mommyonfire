		...
		show: function(options) {
			...
			datePicker.on('click', '.calendar .day', function(e) {
				...
				if ( opts.selectDate( test ) ) {
			      ...
			      dateja.setDate(date.getDate() + parseInt(numDays)); 
			      dateja.setFullYear(dateja.getFullYear(), dateja.getMonth(), dateja.getDate());
			      var formatted2 = opts.formatDate(dateja);
				  $('#date2').val(formatted2);
			});
